              ...
              <div className="pill-grid">
                {tech.map((t, i) => (
                  ...
                  >
                    ...
                    {/* floating popover with detail */}
                    <span className="pill-pop">
            ...
            <div className="col-10">
              <div className="alert alert-warning border-0 rounded-4">
                ...
                <p className="mb-0 small">
                  This application is <strong>not</strong> a production system
                  and <strong>should not</strong> be used for real trading or
